...
entt::entity createDoorFront(entt::registry& registry)
{
    ...
    {
        const sf::Texture* tex = Texture_bank::getTexture("assets/tiles/Door_front_open.png");
    ...
    {
        const sf::Texture* tex = Texture_bank::getTexture("assets/tiles/Door_front_closed.png");
...
entt::entity createDoorSide(entt::registry& registry)
{
    static auto open_frames = []
    {
        const sf::Texture* tex = Texture_bank::getTexture("assets/tiles/Door_side_open.png");
    ...
    static auto closed_frames = []
    {
        const sf::Texture* tex = Texture_bank::getTexture("assets/tiles/Door_side_closed.png");
